...
/**
 * Servlet implementation class VideoPostSearchServlet
 */
@WebServlet("/board/VideoPostSearch.do")
public class VideoPostSearchServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public VideoPostSearchServlet() {
        super();
	...
	int currentPage;
		...
		HashMap<String,Object> map = bService.VideoSearchPost(currentPage,keyword,type);
