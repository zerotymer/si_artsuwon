...
/**
 * Servlet implementation class BoardSelectContentServlet
 */
@WebServlet("/board/NoticeSelectContent.do")
public class NoticeSelectContentServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Board board = bService.NoticeSelectOnePost(boardNo);
		

		RequestDispatcher view = request.getRequestDispatcher("/views/board/notice-board-content.jsp");
