 ...
 */
@WebServlet("/board/NewsAllSelect.do")
public class NewsBoardAllSelectServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public NewsBoardAllSelectServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		HashMap<String, Object> pageDataMap = bService.NewsSelect(currentPage);
