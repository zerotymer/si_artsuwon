                 ...
                 <div class="col-lg-6" style="margin-left: 6%;">
                   <div class="p-5" style="width:180%;">
                     <div class="text-center">
                      ...
                      <div class="mb-3">
	                       <button class="btn btn-primary d-block btn-user w-100" id="pwdChangeBtn">비밀번호 변경</button>
                      </div>
                      </c:if>  
                      
                      <div class="mb-3">
	                      <input class="form-control form-control-user" type="text" name="adminName" value="${requestScope.admin.adminName }">
                      </div> 
                          
	                  <div class="mb-3">
	                      <input class="form-control form-control-user" type="text" name="adminEmail" value="${requestScope.admin.adminEmail }">
                      </div> 
                      
                      <button class="btn btn-primary d-block btn-user w-100" id="editBtn">수정하기</button>
                         <hr>
	                        </div>
	                    </div>
	                </div>
