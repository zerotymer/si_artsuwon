                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td colspan="3"><%= r.getReservationNo() %></td>
                        </tr>
                        <tr>
    ...
    <form action="/member/memberUpdate.do" method="post">
        <div class="change">
            <div class="basic_info">
               <table class="table">
                  ...
                  <tbody>
                    <tr>
                      <th scope="row"> 이름 </th>
                      <td colspan="3"><%=m.getMemberName() %></td>
                    </tr>
                    <tr>
                      <th scope="row"> 생년월일 </th>
                      <td colspan="3"><%=m.getBirthDate() %></td>
                    </tr>
                    <tr>
                      <th scope="row"> 성별 </th>
                      <td colspan="3"><%if(m.getGender()=='M'){ %>
                        남자
                      <%}else{ %>
                        여자
                      <%} %> </td>
            ...
            <div class="detail_info">
                ...
                <button class="btn btn-primary" id="loginBtn" type="reset" style="background-color: #D8D8D8;" >취소</button>
                <button class="btn btn-primary" id="loginBtn" type="submit" style="background-color: #ED4C00;" >변경하기</button>
                
            </div>
        </div>
        
        </form>
         <button class="btn btn-primary" id="loginBtn" type="submit" style="background-color: #363636" >회원탈퇴</button>     
    </div>
